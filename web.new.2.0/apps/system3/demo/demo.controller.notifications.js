define(['apps/system3/demo/demo.controller'], function (app) {
    ...
    app.controller("demo.controller.notifications", function ($scope) {
        ...
        $scope.show = function () {
            ...
            notifContent = $('#' + $scope.content + '-preview').html();

            if ($scope.method == 'validation') generate(position, container, notifContent, true);
