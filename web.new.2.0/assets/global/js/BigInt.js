...
BigInt.prototype.add = function (b) {
    ...
    return bigint_plus(this, b);
}

BigInt.prototype.and = function (b) {

    var maxLen = this.len > b.len ? this.len : b.len;

    var result = new BigInt(maxLen);
...
BigInt.prototype.permissionCheck = function (b) {

    var minLen = this.len > b.len ? b.len : this.len;

    for (var i = 0; i < minLen; i++) {
        if ((this.digits[i] & b.digits[i]) > 0) {
            return true;
        };
    }
